...
class KassaFetcher
  ...
  USER_AGENT = 'Opera/12.02 (Android 4.1; Linux; Opera Mobi/ADR-1111101157; U; en-US) Presto/2.9.201 ' \
    'Version/12.02'.freeze
  WIDGET_ID = 16_857

  PAGE_SIZE = 20
  URL_FOR_PRICES = 'http://m.kassa.rambler.ru/place/hallplanajax'.freeze
  READ_TIMEOUT = 5
